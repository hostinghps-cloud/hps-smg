...
<div class="container-fluid">
                    ...
                    <div class="col-md-3">
                        ...
                        <select
                            ...
                            <option value="{{ $batch->kode_upload }}"
                                {{ request('kode_upload') == $batch->kode_upload ? 'selected' : '' }}>
                                {{ $batch->kode_upload }}
                            </option>
                            @endforeach
                        </select>
    ...
    <form method="POST" id="bulkForm" enctype="multipart/form-data">
        ...
        <!-- ★★★ DIUBAH (1/5): Modal Preview dipindah dari dalam tbody ke sini,
                    ...
                    <div class="modal-dialog modal-lg modal-dialog-scrollable">
                        ...
                        <div class="modal-content border-0" style="border-radius:18px;">
                            ...
                            <div class="modal-body">
                                ...
                                <!-- ★★★ DIUBAH (2/5): List case di modal ini awalnya div class="row" berisi
                ...
                <form method="POST" id="editTemplateForm">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="mb-3">
                            ...
                            <!-- ★★★ DIUBAH (3/5): Textarea ini sekarang "ditumpangi" Summernote
    ...
    <script>
        document
            ...
            .addEventListener('click', function() {
                ...
                // ★★★ DIUBAH (4/5): baris di bawah ini BARU. Textarea saja tidak cukup
    ...
    <!-- ★★★ DIUBAH (5/5): Seluruh blok di bawah ini BARU ditambahkan.
